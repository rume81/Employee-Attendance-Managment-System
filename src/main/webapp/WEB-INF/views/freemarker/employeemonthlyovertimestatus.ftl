...
<div class="col-xs-12 no_padding">
    ...
    <div class="col-xs-10 no_padding">
    	<form name="empmonthlyovertimestatusdownload" id="empmonthlyovertimestatusdownload" action="${rc.contextPath}/empmonthlyovertimestatusdownload" method="get">
	    	<div class="col-xs-12 no_padding">
	    		<table class="table table-bordered table-responsive">
	                ...
	                <tr>
	                    ...
	                    <td>
	                    	<button type="button" title="Search Attendance" class="btn btn-primary" onclick="empOvertimeStatus('${rc.contextPath}')">Search</button>
	                    </td>
	                </tr>
	            </table>
	    	</div>

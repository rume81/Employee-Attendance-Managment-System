...
<h3><center>Employee Work Information</center></h3>
<div class="col-xs-12">
        ...
        <tbody>
        	<#list allEmp as empInfo>
	        	<tr>
	                ...
	                <td>
	                    <div class="btn-group">
	                        <button type="button" title="View Employee Work Info" class="btn btn-primary" onclick="viewEmpWorkInfo('${rc.contextPath}','${empInfo.emp_id}');"><i class="fa fa-file-text"></i></button>
	                        <button type="button" title="Add Employee Work Info" class="btn btn-success" onclick="addEmpWorkInfo('${rc.contextPath}','${empInfo.emp_id}');"><i class="fa fa-floppy-o"></i></button>
	                    </div>
	                </td>
	            </tr>
            </#list>

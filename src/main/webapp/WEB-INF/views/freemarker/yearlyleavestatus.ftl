...
<h3><center>Yearly Leave Status</center></h3>
	                ...
	                <tr>
	                    <td>
	                    	<select name="year" id="year" class="form-control SlectBox">
		                    	...
		                    	<#list disyear as y>
		                        <option value="${y}" <#if year==y>selected="selected"</#if>>${y}/${y+1!''}</option>
		                        </#list>          
		                    </select>
	                    </td>
	                    <td colspan="2">
	                    	<button type="button" title="Search Attendance" class="btn btn-primary" onclick="getYearlyLeave('${rc.contextPath}');">Search</button>
	                    </td>
	                </tr>
	            </table>
        	</div>
